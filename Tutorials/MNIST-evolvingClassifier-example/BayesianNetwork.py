...
#                     pi_i = (2**(iterations- batch_i)-1)/(2**(iterations)-1)
                    optimizer.zero_grad()
...
#                         loss_prior = (pi_i)*self.model_list[t].get_gaussiandistancefromprior(mu_new, mu_prev, rho_prev)
...
#                 print( np.sum(self.model_list[1].Linear_layer[2].mu.weight.data.numpy(), 1) )
